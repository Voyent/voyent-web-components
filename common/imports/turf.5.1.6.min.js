// A customized version of turf that only contains the folllwing functions: booleanWithin, difference, intersect, kinks, lineIntersect
// Built using https://turfjs-builder.herokuapp.com/
...
},{"@turf/helpers":8,"@turf/invariant":10}],5:[function(require,module,exports){
...
},{"@turf/bbox":2,"@turf/boolean-point-in-polygon":3,"@turf/boolean-point-on-line":4,"@turf/invariant":10}],6:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/invariant":10}],7:[function(require,module,exports){
...
},{"@turf/area":1,"@turf/helpers":8,"@turf/invariant":10,"@turf/meta":14,"turf-jsts":17}],8:[function(require,module,exports){
...
},{"@turf/clean-coords":6,"@turf/helpers":8,"@turf/invariant":10,"@turf/truncate":15,"turf-jsts":17}],10:[function(require,module,exports){
...
"use strict";function kinks(e){var n,t,o={type:"FeatureCollection",features:[]};if(t="Feature"===e.type?e.geometry:e,"LineString"===t.type)n=[t.coordinates];else if("MultiLineString"===t.type)n=t.coordinates;else if("MultiPolygon"===t.type)n=[].concat.apply([],t.coordinates);else{if("Polygon"!==t.type)throw new Error("Input must be a LineString, MultiLineString, Polygon, or MultiPolygon Feature or Geometry");n=t.coordinates}return n.forEach(function(e){n.forEach(function(n){for(var t=0;t<e.length-1;t++)for(var r=t;r<n.length-1;r++){if(e===n){if(1===Math.abs(t-r))continue;if(0===t&&r===e.length-2&&e[t][0]===e[e.length-1][0]&&e[t][1]===e[e.length-1][1])continue}var i=lineIntersects(e[t][0],e[t][1],e[t+1][0],e[t+1][1],n[r][0],n[r][1],n[r+1][0],n[r+1][1]);i&&o.features.push(helpers.point([i[0],i[1]]))}})}),o}function lineIntersects(e,n,t,o,r,i,l,u){var s,a,f,c,y,p={x:null,y:null,onLine1:!1,onLine2:!1};return 0===(s=(u-i)*(t-e)-(l-r)*(o-n))?null!==p.x&&null!==p.y&&p:(a=n-i,f=e-r,c=(l-r)*a-(u-i)*f,y=(t-e)*a-(o-n)*f,a=c/s,f=y/s,p.x=e+a*(t-e),p.y=n+a*(o-n),a>=0&&a<=1&&(p.onLine1=!0),f>=0&&f<=1&&(p.onLine2=!0),!(!p.onLine1||!p.onLine2)&&[p.x,p.y])}var helpers=require("@turf/helpers");module.exports=kinks,module.exports.default=kinks;
...
},{"@turf/helpers":8,"@turf/invariant":10,"@turf/line-segment":13,"@turf/meta":14,"geojson-rbush":16}],13:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/invariant":10,"@turf/meta":14}],14:[function(require,module,exports){
...
},{"@turf/helpers":8}],15:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/meta":14}],16:[function(require,module,exports){
...
module.exports={booleanWithin:require("@turf/boolean-within"),lineIntersect:require("@turf/line-intersect"),difference:require("@turf/difference"),kinks:require("@turf/kinks"),intersect:require("@turf/intersect")};
},{"@turf/boolean-within":5,"@turf/difference":7,"@turf/intersect":9,"@turf/kinks":11,"@turf/line-intersect":12}]},{},[18])(18)
});
