...
Voyent.QueryChainEditor = Polymer({
    is: "voyent-query-chain-editor",

    properties: {
        /**
         * Defines the Voyent realm to build query chains for.
         */
        realm: { type: String },
        /**
         * Defines the Voyent account to build query chains for.
         */
        account: { type: String },
        /**
